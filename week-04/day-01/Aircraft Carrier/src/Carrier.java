...
public class Carrier {
    ...
    void fill() {
        if (this.ammoStorage == 0) {
            System.out.println("Zero ammo, nothing to refill, sorry.");
        } else {
    ...
    void getStatus() {
        if (this.HP == 0) {
            ...
            System.out.println("HP: " + this.HP + ", Aircraft count: " + this.carrier.size() + ", Ammo Storage: " + this.ammoStorage + ", Total Damage: " + this.allDamage() + "\nAircraft:");
            for (int i = 0; i < this.carrier.size(); i++) {
